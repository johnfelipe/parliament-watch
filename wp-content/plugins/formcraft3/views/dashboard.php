...
if ( !empty($f3_key_temp) )
{
	...
	if ( $difference_checked > 7 )
	{
		...
		$response = wp_remote_get("http://formcraft-wp.com?type=verify_license&key=".$key."&email=".$email."&site=".rawurlencode(site_url()));		
...
<div class='formcraft-css'>
	...
	<nav class='nav-tabs main-tabs' data-content='#main_tabs'>
				...
				<div class='large-4 column'>
					<div class='subs_options'>
						...
						<span class='opt-cover'>
							<span data-toggle='fc_modal' data-target='#new_form_modal' id='add-new-form'><i class='icon-plus'></i><?php _e('Add New','formcraft') ?></span>
					...
					<div id='form_options' class='block'>
						<div id='chart-options'>
							<span class='hide-checkbox update-checkbox'>
								...
								<label class='active'><input value='week' name='pre-selected' checked='checked' type='radio'> <?php _e('Week','formcraft'); ?></label>
					...
					<div class='block'>
						<div class='table_list subs_list <?php echo $total_subs==0?'no-subs':''; ?>' cellpadding='0' cellspacing='0'>
							...
							<div class='tr thead'>
								...
								<span style='width:39%;float:right' class='sortable' data-sort='created'><?php _e('Received','formcraft'); ?><i class='icon-angle-down'></i><i class='icon-angle-up'></i></span>
							</div>
							<div class='tbody'>
							</div>
