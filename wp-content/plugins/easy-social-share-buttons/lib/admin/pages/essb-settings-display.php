...
$easy_mode_address = esc_url(add_query_arg ( 'easy-mode', 'true', 'admin.php?page=essb_settings&tab=display' ));
$easy_mode_text = "Turn off Advanced Functions";

if ($active_easy_mode) {
	$easy_mode_address = esc_url(add_query_arg ( 'easy-mode', 'false', 'admin.php?page=essb_settings&tab=display' ));
	...
	?>
		...
		<div class="essb-options" id="essb-options">
			<div class="essb-options-header" id="essb-options-header">
				...
				<?php echo '<a href="'.esc_url(add_query_arg ( 'easy-mode', 'true', 'admin.php?page=essb_settings&tab=wizard' )).'" text="' . __ ( 'Configuration Wizard', ESSB_TEXT_DOMAIN ) . '" class="button">' . __ ( 'Configuration Wizard', ESSB_TEXT_DOMAIN ) . '</a>'; ?>
