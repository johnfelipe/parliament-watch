...
class EasySocialShareButtons_Admin {
	...
	function __construct() {
		...
		if (is_admin ()) {
			...
			//addNoticeESSB3
			add_action ( 'admin_notices', array ($this, 'addNoticeESSB3' ) );
		}
	...
	public function addNoticeESSB3() {
		$dismiss_version3 = get_option('essb-dismiss3');
		if (!isset($dismiss_version3)) {
			$dismiss_version3 = "";
		}
		
		if (empty($dismiss_version3)) {
		?>
				...
				<div class="updated fade">
					<p>
						<strong><a
							href="http://codecanyon.net/item/easy-social-share-buttons-for-wordpress/6394476?ref=appscreo"
							target="_blank">Easy Social Share Buttons for WordPress</a></strong>
						version 3 was released with huge network list update and tons of new features included. <a href="<?php echo admin_url('admin.php?page=essb_settings&tab=update3');?>" class="button">Click here to see how to update to version 3</a> <a href="<?php echo admin_url('admin.php?page=essb_settings&tab=general&autoactivate=update3-dismiss');?>" class="button" style="float: right;">Dismiss this message</a>
					</p>
