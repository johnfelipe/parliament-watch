...
/**
 * Plugin Name: Cost Calculator (shared on wplocker.com)
		...
		$output = '<div class="btQuoteBooking ' . $el_class . ' ' . $css_class . '" ' . $style_attr . '><div class="btQuoteBookingWrap">';
			$output .= '<div class="btQuoteBookingForm btActive">';
				...
				$output .= '<div class="btTotalNextWrapper">';
					...
					if ( $paypal_email == '' ) {
						$output .= '<div class="boldBtn btnAccent btnSmall btnIco"><button type="submit" class="btContactNext">' . __( 'Submit', 'bt_plugin' ) . '</button></div>';
					} else {
				...
				$output .= '<div class="btTotalQuoteContactGroup">';
					...
					$output .= '<div class="btQuoteContact">';
						...
						if ( $email_confirmation == 'yes' ) {
							$output .= '<div class="bt_cc_email_confirmation_container"><input id="bt_cc_email_confirmation" type="checkbox" value="yes"><label for="bt_cc_email_confirmation">' . __( 'Email me my budget!', 'bt_plugin' ) . '</label></div>';
						}						
