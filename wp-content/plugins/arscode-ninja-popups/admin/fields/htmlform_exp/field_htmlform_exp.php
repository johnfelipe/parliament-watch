...
class SNP_NHP_Options_htmlform_exp extends SNP_NHP_Options
{
	...
	echo '<textarea style="width: 100%; height: 300px;" id="' . $this->field['id'] . '' . $this->field['vcb_id'] . '" name="' . $this->args['opt_name'] . '' . $this->field['vcb'] . '[' . $this->field['id'] . ']" class="' . $class . '" /></textarea><br />';
