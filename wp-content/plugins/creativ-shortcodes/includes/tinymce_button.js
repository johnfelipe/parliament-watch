(function () {
    ...
    tinymce.PluginManager.add('creativ_shortcodes', function (editor, url) {

        // Add a button that opens a window
        editor.addButton('creativ_shortcodes_button', {
...
\
        ...
        form.find('.creativ-shortcodes-form-types ul li a').click(function () {
            ...
            jQuery('.creativ-shortcodes-form .creativ-shortcodes-form-types').css({
                "height": jQuery('.creativ-shortcodes-form-tabs').outerHeight()
            });
            return false;
        });
        ...
        jQuery('.column-structures a').click(function () {
            ...
            jQuery('#creativ-shortcodes-form-tab_columns textarea').attr({
                'disabled': 'disabled'
            });
            var i = -1;
