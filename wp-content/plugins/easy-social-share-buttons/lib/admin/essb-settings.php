...
$tabs = array ('general' => __ ( 'Main Settings', ESSB_TEXT_DOMAIN ), 'display' => __ ( 'Display Settings', ESSB_TEXT_DOMAIN ), 'customizer' => __ ( 'Style Settings', ESSB_TEXT_DOMAIN ), 'shortcode2' => __ ( 'Shortcode Generator', ESSB_TEXT_DOMAIN ), "stats" => "Click Statistics", "backup" => "Import/Export Settings", "update" => "Automatic Updates", "update3" => "Update to version 3" );
...
switch ($current_tab) :
	...
	case "fans" :
		...
		break;
	case "update3" :
			include (ESSB_PLUGIN_ROOT . '/lib/admin/pages/essb-settings-update3.php');
			break;
	case "wizard" :
