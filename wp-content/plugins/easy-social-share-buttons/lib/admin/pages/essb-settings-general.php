...
if ($autoactivate != '') {
	switch ($autoactivate) {
		...
		case "native-counters" :
			...
			update_option ( EasySocialShareButtons::$plugin_settings_name, $current_options );
			break;
		case "update3-dismiss":
			update_option('essb-dismiss3', "yes");
			break;
	}
...
$easy_mode_address = esc_url(add_query_arg ( 'easy-mode', 'true', 'admin.php?page=essb_settings&tab=general' ));
$easy_mode_text = "Turn off Advanced Functions";

if ($active_easy_mode) {
	$easy_mode_address = esc_url(add_query_arg ( 'easy-mode', 'false', 'admin.php?page=essb_settings&tab=general' ));
		...
		<div class="essb-options" id="essb-options">
			<div class="essb-options-header" id="essb-options-header">
				...
				<?php echo '<a href="#" text="Back to top" class="button button-essb button-backtotop" onclick="essb_backtotop(); return false;">Back to top</a>'; ?>
								...
								<?php echo '<a href="'.esc_url(add_query_arg ( 'easy-mode', 'true', 'admin.php?page=essb_settings&tab=wizard' )).'" text="' . __ ( 'Configuration Wizard', ESSB_TEXT_DOMAIN ) . '" class="button button-essb">' . __ ( 'Configuration Wizard', ESSB_TEXT_DOMAIN ) . '</a>'; ?>
