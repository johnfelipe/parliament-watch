...
<div class="wrap">
		...
		<div class="essb-shortcode-container essb-shortcode-select">
			...
			<a href="<?php echo esc_url(add_query_arg ( 'code', 'easy-social-share', 'admin.php?page=essb_settings&tab=shortcode2' ));?>" class="essb-shortcode essb-shortcode-fixed">[easy-social-share]<br/><span class="essb-shortcode-comment">Shortcode to display social share buttons</span></a>
			<a href="<?php echo esc_url(add_query_arg ( 'code', 'easy-social-like', 'admin.php?page=essb_settings&tab=shortcode2' ));?>" class="essb-shortcode essb-shortcode-fixed">[easy-social-like]<br/><span class="essb-shortcode-comment">Shortcode to display native social buttons</span></a>
			<a href="<?php echo esc_url(add_query_arg ( 'code', 'easy-total-shares', 'admin.php?page=essb_settings&tab=shortcode2' ));?>" class="essb-shortcode essb-shortcode-fixed">[easy-total-shares]<br/><span class="essb-shortcode-comment">Shortcode to display total shares</span></a>
			<a href="<?php echo esc_url(add_query_arg ( 'code', 'easy-share', 'admin.php?page=essb_settings&tab=shortcode' ));?>" class="essb-shortcode essb-shortcode-fixed">[easy-share]<br/><span class="essb-shortcode-comment">Version 1.x general shortcode</span></a>			
		</div>
