...
add_action('mb_display_notices', array('maxAdmin', 'formResponseModals')); 
...
class maxAdmin 
{
	...
	?> 
			...
			<div>
			<a
			  href="https://twitter.com/maxfoundry"
			   class="twitter-follow-button" data-show-count="true" data-show-screen-name="false">
			<?php _e("Follow","maxbuttons"); ?></a></div>
	...
	?>	   
        <div class="ads">
        	 ...
        	 <h3 class='header'>
        	 	<img src="<?php echo $ad_url ?>ad_logo.png"> 
        	 </h3>
        	
        	<span class='img'><img src="<?php echo $ad_url ?>facebook_button.png"></span>
        	...
        	<span class='img'><img src="<?php echo $ad_url ?>idea_button.png"></span>
            ...
            <span class='img'><img src="<?php echo $ad_url ?>green_buttons.png"></span>
            ...
            <ul>
                ...
                <li><?php _e('10 Free Button Packs','maxbutons'); ?></li>
            </ul>

       		<span class='img'><img src="<?php echo $ad_url ?>social_buttons.png"></span>		

 			<ul>
             	<li><?php _e("17 Free Social Share Sets","maxbuttons"); ?></li>
             	<li class='plus'> + </li>
                <li><?php _e('Our Terrific Support', 'maxbuttons'); ?></li>
			</ul>

            <div class='ads_button_wrap'><a class="button" href="https://maxbuttons.com/shop/?add-to-cart=231&direct=1&utm_source=mbf-dashboard409&utm_medium=mbf-plugin&utm_content=MBF-sidebar-22&utm_campaign=inthecart412" target="_blank" ><?php _e('Get MaxButtons Pro', 'maxbuttons'); ?></a></div>
        </div>
        
        <div class="ads"> 
        	<h3 class='header'><?php _e("Everything for $99","maxbuttons"); ?></h3>
            ...
            <div class='ads_button_wrap'><a class="button" href="http://www.maxbuttons.com/pricing/?utm_source=mbf-dashboard&utm_medium=mbf-plugin&utm_content=EBWG-sidebar-22&utm_campaign=inthecart60" target="_blank"><?php _e('Get Everything Now!', 'maxbuttons'); ?></a></div>        	
        </div>
        
        <div class="ads">
            <h3 class='header'><?php _e('Get MaxGalleria', 'maxbuttons'); ?></h3>
            <p><?php _e('Download our free WordPress Gallery plugin MaxGalleria!  Add-ons for Albums, Videos, and Image Sliders.', 'maxbuttons'); ?></p>
            <div class='ads_button_wrap'><a class="button" href="https://wordpress.org/plugins/maxgalleria/?utm_source=mbf-dashboard&utm_medium=mbf_plugin&utm_content=MG_sidebar&utm_campaign=MG_promote" target="_blank"><?php _e('Get MaxGalleria Now!', 'maxbuttons'); ?></a></div>
        </div>
   ...
   <!--     <div class="ads">
	...
	<h3><?php _e("Welcome to MaxButtons Social Sharing", "maxbuttons"); ?></h3>
	...
	<p><?php _e("MaxButtons comes with 5 terrific free sets of Social Sharing buttons for you to use: Notched Box Social Share, Modern Social Share, Round White Social Share, Social Share Squares, Minimalistic Share Buttons and uses the installed font Trebuchet MS.  You can also add any other button you have made to a collection of Social Sharing buttons.","maxbuttons"); ?></p>
...
<p><?php _e("Click Get Started and we will have your social media icons up and running on your site super quick!","maxbuttons"); ?></p>
