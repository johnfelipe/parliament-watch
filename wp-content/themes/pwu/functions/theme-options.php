  ...
  $custom_settings = array( 
    ...
    'settings'        => array( 
      ...
      array(
        ...
        'label'       => __( 'Read More Button Text', 'essentials' ),
        'desc'        => __( 'Enter the text you want to appear on all your \'more\' buttons. Standard text used generally is "Read More".', 'essentials' ),
        'std'         => __( 'Read More', 'essentials' ),
        'type'        => 'text',
        'section'     => 'setup',
        'rows'        => '',
        'post_type'   => '',
