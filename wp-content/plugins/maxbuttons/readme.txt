...
Tags: icon, icons, link, seo, wordpress button plugin, wordpress button generator, css3 button plugin, gradient, css3 button generator, css wordpress button, css3 wordpress button, social button, simple social buttons, wordpress buttons plugin, wp button creator, wordpress button, button generator, create button icon, font awesome, fontawesome, responsive, responsive buttons, google, google event tracking, google analytics, facebook, facebook icon, facebook like, floating social media, follow, icon, icons, Like, linkedin, linkedin icon, page builder, sharing, sharing buttons, siteorigin widget, social media, css button generator, social media icons, social media plugin, social media sharing, social profiles, social share, tweet, twitter, tweet button, tweet 
...
== Description ==
MaxButtons is a WordPress Button plugin that creates great-looking CSS3 WordPress buttons to be used on any post or page on your site. The easy to use button editor makes it a snap to generate awesome CSS3 buttons in very little time.
...
* How to Create WordPress Buttons using a [WordPress Button Plugin?](https://www.maxbuttons.com/#CSS3/?utm_source=wordpress&utm_medium=mbrepo&utm_content=how-to-create&utm_campaign=plugin) 
* How to make a [WordPress Buttons](https://www.maxbuttons.com/?utm_source=wordpress&utm_medium=mbrepo&utm_content=how-to-make&utm_campaign=plugin)? 
* What is a [CSS3 Button Generator](https://maxbuttons.com/?utm_source=wordpress&utm_medium=mbrepo&utm_content=what-is-generator&utm_campaign=plugin)?
* [Social Share Buttons](https://maxbuttons.com/?utm_source=wordpress&utm_medium=mbrepo&utm_content=social_sharing&utm_campaign=plugin). How do I install them on my site?
* What's the best [Font Awesome WordPress](https://maxbuttons.com/?utm_source=wordpress&utm_medium=mbrepo&utm_content=font_awesome&utm_campaign=plugin) plugin?


= WordPress Button Pack Libraries =

* [How do Button Pack libraries make me and my firm more effective?](https://maxbuttons.com/product-category/button-packs/?utm_source=wordpress&utm_medium=mbrepo&utm_content=button_pack&utm_campaign=repo)
* [What is a good Vector Icon Library to use with MaxButtons Pro?](http://maxvectors.com/)

= Highlights =

* 5 beautiful, configurable Social Sharing sets
...
Take your buttons to the next level with [MaxButtons Pro](https://www.maxbuttons.com/pricing/?utm_source=wordpress&utm_medium=mbrepo&utm_content=MBPro&utm_campaign=plugin), which gives you additional features such as:

**Social Sharing Buttons**

With Version 4 MaxButtons now includes the [best Social Sharing plugin](https://maxbuttons.com/?utm_source=wordpress&utm_medium=mbrepo&utm_content=best_social_share&utm_campaign=plugin) capabilities. MaxButtons Pro ships with an additional 12 beautifully designed Social Sharing sets that let you your visitors connect with you on Facebook, Twitter, Pinterest, Linkedin, Google+, StumbleUpon, Reddit and Digg.  Plus you can use the advanced functions below to design and configure buttons with icons for use in your social sharing sets.

**Advanced WordPress Button Design and Set Up**

MaxButtons strives to bring you the [best CSS3 Button Generator](https://maxbuttons.com/?utm_source=wordpress&utm_medium=mbrepo&utm_content=best_css3_button&utm_campaign=plugin) through continuous feature updating.  It is not just that you can generate beautiful buttons with icons.  You can use Font Awesome Icons and Google Analytics Event Tracking without writing a line of code.
...
And the best part is that you can get this awesome [CSS3 button generator](https://maxbuttons.com/?utm_source=wordpress&utm_medium=mbrepo&utm_content=CSS3&utm_campaign=plugin) for **only $19!**. You don’t have to take our word the MaxButton Pro is the [best WordPress button plugin](https://maxbuttons.com/best-wordpress-button-plugins/). Read our customer’s reviews.
...
[Follow us on Twitter](http://www.twitter.com/maxfoundry/)
