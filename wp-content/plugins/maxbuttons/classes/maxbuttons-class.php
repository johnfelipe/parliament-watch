...
class maxButtonsPlugin
{
	...
	*/
	...
	function add_admin_scripts($hook) {	
		...
		//$local["windowtitle"] = __("Select a MaxButton","maxbuttons"); // moved to media_button js 
	...
	//	global $pagenow, $wp_version;
		...
		wp_enqueue_script('mb-media-button', $this->plugin_url . 'js/maxbuttons_media_button.js', array('jquery'), null, true); 
