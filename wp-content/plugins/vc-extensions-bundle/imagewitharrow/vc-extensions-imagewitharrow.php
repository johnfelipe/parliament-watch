...
if (!class_exists('VC_Extensions_ImageWithArrow')) {
    ...
    class VC_Extensions_ImageWithArrow {
        ...
        function cq_vc_imagewitharrow_func($atts, $content=null) {
          ...
          $output .= '<div style="height:'.$height.';margin:'.$containermargin.';" class="cq-imgwitharrow-container '.$elementshape.' '.$captionalign.' '.$extra_class.'" data-color="'.$textcolor.'" data-background="'.$textbg.'" data-captionalign="'.$captionalign.'" data-arrowtop="'.$arrowtop.'" data-arrowleft="'.$arrowleft.'" data-fontsize1="'.$fontsize1.'" data-fontsize2="'.$fontsize2.'" data-iwidth="'.$iwidth.'" data-iheight="'.$iheight.'" data-twidth="'.$twidth.'" data-theight="'.$theight.'" data-arrowsize="'.$arrowsize.'">';
