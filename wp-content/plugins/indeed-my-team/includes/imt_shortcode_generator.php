...
<div class="">
        ...
        <div class="box-title">
         ...
         <div id="the_shc_settings" class="ict_settings_wrapp">
            <div class="ict_column column_one">
                    <h4 style="background-color: rgb(66, 66, 66);"><i class="icon-dispent"></i><?php echo __('Display Entries', 'imt');?></h4>
					<div class="ict_settings_inner">
						<table style="width:100%">
                            <tr>
                                ...
                                <td>
                                    <select id="team" onchange="ict_select_team(this);ict_preview();" class="ict_select_field_vl" multiple  style="width:100%">
				 ...
				 <h4 style="margin-top:15px; background: rgba(240, 80, 80, 1.0);"><i class="icon-memlink"></i><?php echo __('Member Link', 'imt');?></h4>
				  <div class="ict_settings_inner">
				 <table style="width:100%">
				  <tr>
                                <td>
                                    <span class="ict-strong"><?php echo __('Activate Inside Page', 'imt');?></span>
                                </td>
                                <td>
                                    <?php $selected = checkIfSelected($shortcode_arr['page_inside'], 1, 'checkbox');?>
                                    <input type="checkbox" <?php echo $selected;?> id="page_inside" onClick="imt_uncheck_c(this, '#tm_custom_href');ict_preview();"/>
                                </td>
                            </tr>             
                            <tr>
                                <td colspan="2">
                            ...
                            <tr>
                                <td>
                                    <span class="ict-strong"><?php echo __('Activate Custom Link', 'imt');?></span> 
                                </td>
                                <td>
                                    <?php $selected = checkIfSelected($shortcode_arr['tm_custom_href'], 1, 'checkbox');?>
                                    <input type="checkbox" <?php echo $selected;?> id="tm_custom_href" onClick="imt_uncheck_c(this, '#page_inside');ict_preview();"/>
                                </td>
                            </tr>                            
                    </table>
				  </div>
            ...
            <div class="ict_column column_two">
                  <h4 style="  background-color: rgb(231, 231, 231); color: #333;"><i class="icon-entryinfo"></i><?php echo __('Entry Information', 'imt');?></h4>
				  <div class="ict_settings_inner">
                      <div>
             ...
             <div class="ict_column column_three">
                <h4 style="  background: #1fb5ac;"><i class="icon-temp"></i>Template</h4>
				  <div class="ict_settings_inner">
                    <table style="width:100%;">
                        <tr>
                            ...
                            <td>
                                ...
                                <?php
                                		$themes_arr = imt_admin_get_all_themes();
               ...
               <div class="ict_column column_four">
			      <h4 style="background: #9972b5;"><i class="icon-slider"></i>Slider ShowCase</h4>
			   ...
			   <h4 style="background: #fa8564;"><i class="icon-filter"></i>Filter ShowCase</h4>
			   <div class="ict_settings_inner">
                    <div class="ict-selection">
                        <input type="checkbox" id="filtering" onClick="filtering_set_unset(this);ict_preview();" /> <?php echo __('Show as Filter:', 'imt');?>
                    ...
                    <div id="filtering_options" style="opacity:0.5;">
                        <table >
                            ...
                            <tr>
                                <td colspan="2">
                                	<span class="ict-strong" style="min-width:90px; display: inline-block;">Theme</span>
                            ...
                            <tr>
                                <td colspan="2"><span class="ict-strong" style="min-width:90px; display: inline-block;"><?php echo __('Align', 'imt');?></span>
                            ...
                            <tr>
                            	<td colspan="2"><span class="ict-strong" style="min-width:90px; display: inline-block;"><?php echo __('Layout Mode', 'imt');?></span>
                            		<select id="layout_mode" onChange="ict_preview();">
                            			<?php 
    ...
    <div class="shortcode_wrapp">
        <div class="content_shortcode">
            <div>
                <span style="font-weight:bolder; color: #fff; font-style:italic; font-size:13px;"><?php echo __('ShortCode :', 'imt');?> </span>
                <span class="the_shortcode"></span>
            </div>
            <div style="margin-top:10px;">
                <span style="font-weight:bolder; color: #fff; font-style:italic; font-size:13px;"><?php echo __('PHP Code:', 'imt');?> </span>
