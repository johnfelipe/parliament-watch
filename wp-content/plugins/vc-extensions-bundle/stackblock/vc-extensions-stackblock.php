...
if (!class_exists('VC_Extensions_StackBlock')) {
    class VC_Extensions_StackBlock{
        ...
        function cq_vc_stackblock_func($atts, $content=null) {
          ...
          $i = -1;
          $output = '';
          $output .= '<div class="cq-stackblock" data-elementheight="'.$elementheight.'" data-contentwidth="'.$contentwidth.'" data-textalign="'.$textalign.'" data-fontsize="'.$fontsize.'" data-tooltip="'.$tooltip.'">';
