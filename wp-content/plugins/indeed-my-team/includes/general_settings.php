...
<div class="ict_wrap">
	...
	<form method="post" action="">	    
		...
		<div class="stuffbox">
            ...
            <div class="inside">
            	<div>
                    <input type="checkbox" onClick="check_and_h(this, '#imt_target_blank');" <?php if ($metas['imt_target_blank']) echo 'checked';?>/>
                    <input type="hidden" value="<?php echo $metas['imt_target_blank'];?>" name="imt_target_blank" id="imt_target_blank" />	            		
            		<?php echo __("Open 'Inside Page' & 'Custom Link' in new Window", 'imt');?>
            	</div>
                <div class="submit">
                	<input type="submit" value="<?php echo __('Save changes', 'imt');?>" name="imt_submit" class="button button-primary button-large" />
                </div>            	
