function ict_preview(){
    ...
    if (jQuery('#tm_custom_href').is(':checked') ){
    	value.tm_custom_href = 1;
    }
...
function ict_update_shortcode(value){
    ...
    if (value.tm_custom_href) str += "tm_custom_href='1' ";
...
function imtTeamCustomHref(v, t){
	if (v<1){
		//display
		jQuery(t).fadeIn(200);
		return;
