	...
	public function setNetwork($network)
	{
		...
		$network_data = array(
	 	...
	 	switch($network)
	 	{
	 		...
	 		break;
	 		case "linkedin": 
	 			$network_data["share_url"] = "http://www.linkedin.com/shareArticle?mini=true&url={url}"; 
	 			$network_data["count_api"] = "http://www.linkedin.com/countserv/count/share?url={url}&format=json"; 
	 		...
	 		case "pinterest": 
	 			...
	 			$network_data["count_api"] = "http://api.pinterest.com/v1/urls/count.json?url={url}"; 
	 			$network_data["json_return_var"] = "count";
	 		...
	 		break;	
	 		case "stumbleupon": 
	 			$network_data["share_url"] = "http://www.stumbleupon.com/submit?url={url}&title={title}";
	 		...
	 		break;	
	 		case "reddit": 
	 			$network_data["share_url"] = "http://reddit.com/submit?url={url}&title={title}";
	 		...
	 		break;
			case "vkontakte": 
				$network_data["share_url"] = "http://vkontakte.ru/share.php?url={url}";
				$network_data["count_api"] = "http://vk.com/share.php?act=count&url={url}";
