jQuery(function($) {
    ...
    var imageFrame;
    $('.meta_box_upload_image_button').live('click',function(e) {
        e.preventDefault();

        var options, attachment;

        javascript$self = $(e.target);
        $div = javascript$self.closest('div.meta_box_image');
    ...
    $('.meta_box_clear_image_button').live('click',function(e) {
          e.preventDefault();
    ...
    $('.meta_box_upload_file_button').click(function(e) {
        ...
        javascript$self = $(e.target);
        $div = javascript$self.closest('div.meta_box_file_stuff');
    ...
    $('a.meta_box_repeatable_add').on('click', function(e) {
        ...
        //var defaultImage = clone.closest('.meta_box_default_image').text();
    ...
    $('a.meta_box_repeatable_remove').live('click', function(e){
        e.preventDefault();
        console.log('removed');
