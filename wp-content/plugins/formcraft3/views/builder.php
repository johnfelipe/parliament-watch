...
<div ng-app='FormCraft' style=''>
	<div class='formcraft-css form-builder-cover hide-form' ng-controller='FormController' ng-init='AngularInit()'>
		<div class='option-box  state-{{Options.show_logic}}' id='form_logic_box'>
			<h2><?php _e('Conditional Logic','formcraft'); ?><i class='icon-angle-left' ng-click='Options.show_logic = false'></i></h2>
			<div class='nav-tabs-slide' data-content='#logic_tabs' style='padding: 15px'>
			</div>
		...
		<div class='option-box  state-{{Options.show_addons}}' id='form_addon_box'>
			<h2><?php _e('Add-Ons','formcraft'); ?><i class='icon-angle-left' ng-click='Options.show_addons = false'></i></h2>
			<nav class='nav-tabs-slide' data-content='#addon_tabs'>
				<span class='active'><?php _e('Installed','formcraft'); ?></span>
				<span><?php _e('Add New','formcraft'); ?></span>
			</nav>
		...
		<div class='option-box state-{{Options.show_options}}' id='form_options_box'>
			<h2><?php _e('Options','formcraft'); ?><i class='icon-angle-left' ng-click='Options.show_options = false'></i></h2>
			<nav class='nav-tabs-slide' data-content='#options_tabs'>
				<span class='active'><?php _e('General','formcraft'); ?></span>
				<span><?php _e('Email','formcraft'); ?></span>
				<span><?php _e('Embed','formcraft'); ?></span>
				<span><?php _e('Custom Text','formcraft'); ?></span>
				<span><?php _e('Extras','formcraft'); ?></span>
			</nav>
			...
			<div id='form_styling_box' class='option-box  state-{{Options.show_styling}}'>
				<h2><?php _e('Styling','formcraft'); ?><i class='icon-angle-left' ng-click='Options.show_styling = false'></i></h2>
				<nav class='nav-tabs-slide' data-content='#styling_tabs'>
					<span class='active'><?php _e('General','formcraft'); ?></span>
					<span><?php _e('Color Scheme','formcraft'); ?></span>
					<span><?php _e('Background','formcraft'); ?></span>
				</nav>
			...
			<div class='options-head'>
				<div>
					<a href='admin.php?page=formcraft3_dashboard' class='button blue' style='width: 126px; text-align: center'><i class='icon-angle-left'></i>Dashboard</a>
					<div class='add_fields'>
						<button class='button blue icon-{{Options.show_fields}}' ng-click='Options.show_fields = !Options.show_fields;Options.show_addons = false;Options.show_options = false;Options.show_styling = false'><i class='icon-angle-down'></i><i class='icon-angle-up'></i><?php _e('Add Field','formcraft') ?></button>
						<div ng-show='Options.show_fields' class='ng-hide fields-list'>
							...
							<div class='adv-fields fake-hover'>
								<div class='button'><?php _e('More Fields','formcraft') ?> <i class='icon-angle-right' style='margin-right: -13px; padding-left: 3px'></i></div>
								<ul class='fields-list'>
									<li><div data-target='#general_modal' data-toggle='fc_modal' href='<?php echo plugins_url( 'general/no-captcha.php', __FILE__ ); ?>' class='button'><?php _e('Captcha','formcraft') ?></div></li>
							...
							<div class='adv-fields fake-hover' style='z-index: 100'>
								<div class='button'><?php _e('Survey','formcraft') ?> <i class='icon-angle-right' style='margin-right: -13px; padding-left: 3px'></i></div>
								<ul class='fields-list'>
							...
							<div class='adv-fields fake-hover fields-nos-{{addField.payments.length}}'>
								<div class='button'>Payments <i class='icon-angle-right' style='margin-right: -13px; padding-left: 3px'></i></div>
								<ul class='fields-list'>
					...
					<div>
						<button id='form_options_button' ng-click='Options.show_options = !Options.show_options; Options.show_styling = false; Options.show_addons = false; Options.show_logic = false' style='width: 114px' class='button blue'><i class='icon-cog-alt'></i> <?php _e('Options','formcraft') ?></button>
					</div>
					<div>
						<button style='width: 108px' id='form_styling_button' ng-click='Options.show_styling = !Options.show_styling; Options.show_addons = false; Options.show_options = false; Options.show_logic = false' class='button blue'><i class='icon-pencil'></i> <?php _e('Styling','formcraft') ?></button>
					</div>
					<div>
						<button id='form_addons_button' ng-click='Options.show_addons = !Options.show_addons; Options.show_styling = false; Options.show_options = false; Options.show_logic = false' style='width: 114px' class='button blue'><i class='icon-puzzle'></i> <?php _e('Add-Ons','formcraft') ?></button>
					</div>
					<div>
						<button id='form_logic_button' ng-click='Options.show_logic = !Options.show_logic; Options.show_styling = false; Options.show_options = false; Options.show_addons = false' style='width: 114px' class='button blue'><i class='icon-shuffle'></i> <?php _e('Logic','formcraft') ?></button>
					</div>		
					<div>
						<button style='width: 135px' id='form_save_button' ng-click='saveForm()' class='button blue'><span class="fc-spinner small"><div class="bounce1"></div><div class="bounce2"></div><div class="bounce3"></div></span><span class='one'><i class='icon-up-circled'></i> <?php _e('Save Form','formcraft') ?></span></button>

						<button style='display: none' id='plugin-save' ng-click='saveForm("plugin_installed")'></button>
					</div>
					<div>
						<button style='width: 115px' type='submit' ng-click='saveForm("preview")' id='form_preview_button' class='button blue'><i class='icon-desktop'></i> <?php _e('Preview','formcraft') ?></button>
					</div>
				</div>		
			</div>
			<div id='help_button_cover'>
				<button data-target='#help_modal' data-toggle='fc_modal' style='width: 88px' type='submit' id='help_button' class='button blue'><i class='icon-help-circled'></i> <?php _e('Help','formcraft') ?></button>
			</div>
			<style>
			...
			<div class='form-cover-builder hide-form hide-form-options'>
				...
				<div id='form-cover-html' class='nos-{{Builder.FormElements.length}}{{Builder.FormElements[0].length}}' style='width: {{Builder.form_width_nos}}px'>
					<div class='fc-pagination-cover fc-pagination-{{Builder.FormElements.length}}'>
						<div class='fc-pagination' style='width: {{Builder.form_width}}px'>
					...
					<div style='width: {{Builder.form_width}}px' class='form_width_change'><span><?php _e('Width','formcraft') ?></span><input ng-model='Builder.form_width' type='text'/>
					</div>
					<!--RTH-->
					<style scoped='scoped'>
						...
						{
							background-color: {{Builder.Config.color_scheme_button}};
						...
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="color"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="date"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="datetime"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="datetime-local"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="email"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="month"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="number"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="tel"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="password"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="search"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="tel"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="text"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="time"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="url"]:focus,
						.formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .form-element-html input[type="week"]:focus,
						...
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="text"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="password"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="color"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="date"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="datetime"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="datetime-local"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="email"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="month"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="number"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="search"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="tel"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="tel"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="time"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="url"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element input[type="week"],
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element select,
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element textarea
						{
							background-color: {{Builder.Config.color_field_background}};
						}
						html .formcraft-css .fc-form.fc-form-<?php echo $form_id; ?> .form-element .error
						{
					...
					<div class='form-cover'>
						<form data-thousand='{{Builder.Config.thousand_separator}}' data-decimal='{{Builder.Config.decimal_separator}}' data-delay='{{Builder.Config.Redirect_delay_seconds}}' data-id='<?php echo $form_id; ?>' class='fc-form fc-form-<?php echo $form_id; ?> label-{{Builder.label_style}} align-{{Builder.form_align}} frame-{{Builder.form_frame}} spin-{{Builder.spin_effect}} save-form-{{Builder.Config.save_progress}} dont-submit-hidden-{{Builder.Config.dont_submit_hidden}} remove-asterisk-{{Builder.form_asterisk}} icons-hide-{{Builder.hide_icons}} field-alignment-{{Builder.form_internal_alignment}}' style='width: {{Builder.form_width}}px; color: {{Builder.Config.font_color}}; font-size: {{Builder.font_size}}%; background: {{Builder.form_background}}'>
						...
						<div class='prev-next prev-next-{{Builder.FormElements.length}}' style='width: {{Builder.form_width}}px; color: {{Builder.Config.font_color}}; font-size: {{Builder.font_size}}%; background: {{Builder.form_background}}'>
