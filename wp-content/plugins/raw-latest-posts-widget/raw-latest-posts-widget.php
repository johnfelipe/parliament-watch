...
class raw_lp_widget extends WP_Widget {
    ...
    public function form($instance) {
        ...
        <p>
            <label for="raw_lp_widget_show_img"><?php _e('Post image position : '); ?></label>
    ...
    public function widget($args, $instance) {
        ...
        if ($cat_recent_posts->have_posts()) {
            ...
            echo '<ul class="latest-post-widget">';
            ...
            while ($cat_recent_posts->have_posts()) {
                ...
                if ($show_img && $post_img_position == 'post_img_before_title'){
                    $this->_show_image();
                }
                ...
                if ($show_img && $post_img_position == 'post_img_after_title'){
                    $this->_show_image();
                }
                    
                if ($show_date || $show_excerpt || $show_categories){
                    echo '<p class="raw_lp_row">';
                }
                    
                if ($show_date){
                    echo '<i class="raw_lp_date">' . get_the_time(get_option('date_format')) . '</i>';
                }
                    
                if ($show_excerpt){
                    echo '<br /><span class="raw_lp_excertp">' . get_the_excerpt() . '</span>';
                }
                ...
                if ($show_categories) {
                    ...
                    foreach ((get_the_category()) as $post_category) {
                        ...
                        if ($category == $post_category->term_id)
                            continue;
